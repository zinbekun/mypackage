...
static const _Query_Event_type_support_symbol_names_t _Query_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, person_msgs, srv, Query_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, person_msgs, srv, Query_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, person_msgs, srv, Query_Event)() {
  return &::person_msgs::srv::rosidl_typesupport_c::Query_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Query_service_type_support_handle = {
  ...
  &Query_Response_message_type_support_handle,
  &Query_Event_message_type_support_handle,
