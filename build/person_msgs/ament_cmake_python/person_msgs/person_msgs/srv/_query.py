...
class Metaclass_Query_Event(type):
    """Metaclass of message 'Query_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__query__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__query__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__query__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__query__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__query__event
...
class Query_Event(metaclass=Metaclass_Query_Event):
    """Message class 'Query_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<person_msgs/Query_Request, 1>',
        'response': 'sequence<person_msgs/Query_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['person_msgs', 'srv'], 'Query_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['person_msgs', 'srv'], 'Query_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from person_msgs.srv import Query_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, Query_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Query_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from person_msgs.srv import Query_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Query_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Query_Response'"
...
class Metaclass_Query(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _query.Metaclass_Query_Event._TYPE_SUPPORT is None:
                _query.Metaclass_Query_Event.__import_type_support__()
...
class Query(metaclass=Metaclass_Query):
    ...
    from person_msgs.srv._query import Query_Event as Event
